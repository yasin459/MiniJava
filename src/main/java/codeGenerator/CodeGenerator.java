...
public class CodeGenerator {
    ...
    public CodeGenerator() {
        CodeGeneratorFacade facade = new CodeGeneratorFacade().bulidCodeGeneratorFacade(memory);
        symbolTable = new SymbolTable(facade);
        // TODO
    }
    ...
    public void kpid(Token next) {
        ss.push(symbolTable.getCodeGeneratorFacade().getKeywordAddress(next.getValue()));
    }
    ...
    public void save() {
        memory.saveMemory();
        ss.push(new Address(memory.calcMemorySize(), varType.Address));
    }
    ...
    public void jpf_save() {
        memory.saveMemory();
        Address save = new Address(memory.calcMemorySize(), varType.Address);
        memory.add3AddressCode(ss.pop().num, Operation.JPF, ss.pop(),
